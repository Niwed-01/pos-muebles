    ...
    <div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="max-w-2xl space-y-6">
        <div className="bg-slate-800 rounded-xl border border-slate-700 p-6 space-y-5">
          ...
          <div>
            <label className="block text-sm font-medium text-slate-300 mb-1.5">Código / SKU</label>
            <input
              {...register("codigo")}
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2 bg-slate-900 border border-slate-700 rounded-lg text-sm text-slate-200 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 resize-none"
          ...
          <div>
            ...
            <select
              {...register("categoryId")}
              className="w-full px-3 py-2 bg-slate-900 border border-slate-700 rounded-lg text-sm text-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500"
            >
        ...
        <div className="bg-slate-800 rounded-xl border border-slate-700 p-6 space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-slate-300 mb-1.5">Costo (RD$)</label>
              <input
                type="number"
                step="0.01"
                {...register("costo")}
                ...
                placeholder="0.00"
              />
              {errors.costo && <p className="mt-1 text-xs text-red-400">{errors.costo.message}</p>}
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-300 mb-1.5">Precio de Venta (RD$)</label>
              <input
                type="number"
                step="0.01"
                {...register("precio")}
        ...
        <div className="bg-slate-800 rounded-xl border border-slate-700 p-6 space-y-4">
          <div className="flex items-center justify-between">
            ...
            {!isNew && (
              <button
                ...
                className="inline-flex items-center gap-2 px-3 py-1.5 bg-slate-700 hover:bg-slate-600 text-slate-200 text-xs font-medium rounded-lg transition-colors"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-slate-900/50 rounded-lg px-4 py-3 border border-slate-700">
              ...
              <p className="text-2xl font-bold text-white font-mono">{stockActual}</p>
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-300 mb-1.5">Stock Mínimo</label>
              <input
                type="number"
              ...
              />
              {errors.stockMinimo && (
                <p className="mt-1 text-xs text-red-400">{errors.stockMinimo.message}</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-800 rounded-xl border border-slate-700 p-6 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-slate-500">{totalImages}/3</span>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            {totalImages < 3 && (
              <button
                ...
                className="aspect-square rounded-lg border-2 border-dashed border-slate-700 hover:border-emerald-500/50 flex flex-col items-center justify-center gap-1 text-slate-500 hover:text-emerald-400 transition-colors"
              >
        ...
        <div className="flex items-center justify-end gap-3">
          ...
          <button
            type="submit"
            disabled={isSaving}
            className="inline-flex items-center gap-2 px-6 py-2 bg-emerald-600 hover:bg-emerald-700 disabled:bg-emerald-600/50 disabled:cursor-not-allowed text-white text-sm font-medium rounded-lg transition-colors"
          >
            {isSaving ? (
              <>
      ...
      {showStockModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-slate-800 rounded-xl border border-slate-700 p-6 w-full max-w-md mx-4">
            ...
            <div className="bg-slate-900/50 rounded-lg px-4 py-3 border border-slate-700 mb-4">
